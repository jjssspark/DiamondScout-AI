...
| 9 확률 캘리브레이션 | 완료 — ECE 0.0126 -> 0.0081, 서빙 반영 | `d51d4f8` |
...
PR #1을 2026-08-18 04:07Z에 main으로 머지했는데, 24분이 지나도 배포된 앱이 구버전이다.
...
이 의존성 구성(gradio, lightgbm, pandas, matplotlib)의 빌드 시간을 넘긴 상태라
"아직 빌드 중"으로 보기 어렵다. 저장소만 보고는 원인을 알 수 없다.
